...
LYRA is attempting to combine the best ideas and technologies currently available in crypto space, such as delegated proof of stake, sharding, and CryptoNote, and apply them to the tokenized financial payment network space. We operate with concepts like “accounts” (both regular and saving) to maximally resemble the existing financial system paradigms, while “authorizers” resemble payment network methods and workflows, which enables faster adoption by mainstream users
